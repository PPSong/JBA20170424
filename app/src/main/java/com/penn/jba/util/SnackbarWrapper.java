...
public class SnackbarWrapper {
    ...
    public static SnackbarWrapper make(@NonNull CharSequence text, InfoType infoType) {
        return new SnackbarWrapper(PPApplication.getContext(), text, 5000, infoType);
    }

    private SnackbarWrapper(@NonNull final Context appplicationContext, @NonNull CharSequence text, @Snackbar.Duration int duration, InfoType infoType) {
